                    ...
                    if not nombre_reg or not inst_reg:
                        ...
                        try:
                            ...
                            supabase.table("equipo").insert({
                                "email": email_reg, "nombre": nombre_reg, "perfil_academico": perfil_reg, 
                                "institucion": inst_reg, "rol": "espera"
                            }).execute()
...
if st.session_state.lab_id == "PENDIENTE":
    ...
    st.write(f"Hola **{st.session_state.get('nombre_usuario', st.session_state.usuario_autenticado)}**. Aún no has sido asignado a ningún laboratorio.")
